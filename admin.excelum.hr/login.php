...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT user FROM users WHERE user = :username AND password = :password");
        ...
        if ($user) {
            ...
            header("Location: index.php?username=" . urlencode($userr));
            exit;
        } else {
    ...
    <div class="container mt-4">
        ...
        <form method="post">
            <div class="text-center mb-3">
                <img src="Excelum-removebg-preview.png" class="rounded" alt="..." style="width: 344px; height: 46px;">
              </div>
